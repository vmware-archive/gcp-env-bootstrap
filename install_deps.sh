...
sudo apt update
sudo apt install -y bosh-bootloader bosh-cli terraform
sudo apt install -y libreadline6 libreadline6-dev
sudo apt install -y build-essential zlibc zlib1g-dev ruby ruby-dev openssl libxslt-dev libxml2-dev libssl-dev libyaml-dev libsqlite3-dev sqlite3 make tree
